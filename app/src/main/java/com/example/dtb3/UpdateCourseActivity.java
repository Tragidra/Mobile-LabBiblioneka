...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    private SQLObrabtchik sQLObrabtchik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sQLObrabtchik = new SQLObrabtchik(UpdateCourseActivity.this);
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sQLObrabtchik.updateCourse(courseName, courseNameEdt.getText().toString(), courseDescriptionEdt.getText().toString(), courseTracksEdt.getText().toString(), courseDurationEdt.getText().toString());
        ...
        deleteCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sQLObrabtchik.deleteCourse(courseName);
